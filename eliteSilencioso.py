...
import urllib.request, winsound, os, time, win32com, win32com.client
...
#creamos una shell que se va a encargar de dar enter para poner a descargar los torrent directamente sin que tengamos que intervenir siquiera
shell = win32com.client.Dispatch('WScript.Shell')
time.sleep(0.5)
for i in range(0,contadorCapitulo): #ejecuta por cada capitulo descargado
	shell.SendKeys("{Enter}") #presiona enter para aceptar el magnet y que se descargue directamente
	time.sleep(1)
